...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    // Give the Managed Object Context to the Login View:
    LQLoginViewController *loginViewController = (LQLoginViewController *)[[rootNav viewControllers] objectAtIndex:0];
