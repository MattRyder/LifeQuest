...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    // Give the Managed Object Context to the Registration View:
    LQRegisterViewController *registerViewController = (LQRegisterViewController *)[[rootNav viewControllers] objectAtIndex:0];
    registerViewController.managedObjectContext = [self managedObjectContext];
